 ...
 * the end of a serial chain. The build step already knows what an external
 * (`file=`/deprecated `<code src>`) demo imports, so `CodeRunner` calls this
 * at mount and the two downloads overlap.
 *
