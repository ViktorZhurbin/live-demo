...
2. Do it after
   [upstream-plugins-actions.md](./upstream-plugins-actions.md) item 1, which
   moves file collection into remark and touches the same `collectDemoFiles`
   path this needs to change.
3. Leave Rollup out.
